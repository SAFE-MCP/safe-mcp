...
- [SAFE-T1303](../SAFE-T1303/README.md): Sandbox Escape via Server Exec - Often the result of successful high-privilege tool abuse.

## References
- [Model Context Protocol Specification](https://modelcontextprotocol.io/specification)
- [MITRE ATT&CK T1066: Inter-Process Communication](https://attack.mitre.org/techniques/T1066/) (Abusing legitimate mechanisms)
- [MITRE ATT&CK T1548: Abuse Elevation Control Mechanism](https://attack.mitre.org/techniques/T1548/)
- [OWASP Top 10 for LLM Applications](https://owasp.org/www-project-top-10-for-large-language-model-applications/)

## MITRE ATT&CK Mapping
- [T1066 - Inter-Process Communication](https://attack.mitre.org/techniques/T1066/)
